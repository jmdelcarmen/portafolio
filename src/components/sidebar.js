    ...
    <div class="sidebar-wrapper">
      <div class="profile-header">
        <div class="dp-group">
          ...
          <img src="./src/img/dp.jpg" alt="me"/>
        </div>
        <h5>marco del carmen</h5>
      ...
      <div class="sidebar-section">
        ...
        <hr>
        <p> Aside from frameworks, I also play around with data analytics, web scraping, and different projects that integrate google and aws services.</p>
        </div>
      </div>
    </div>
  </div>`;
